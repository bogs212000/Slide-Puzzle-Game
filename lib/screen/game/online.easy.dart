...
class OnlineEasy extends StatefulWidget {
  @override
  _OnlineEasyState createState() => _OnlineEasyState();
}

class _OnlineEasyState extends State<OnlineEasy> {
  List<List<int?>> grid = [];
  ...
  final int baseScore = 3000; // Base score
